    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tag_breakfast', models.BooleanField(default=False, help_text='Select if this recipe is suitable for breakfast', verbose_name='Breakfast')),
                ('tag_lunch', models.BooleanField(default=False, help_text='Select if this recipe is suitable for lunch', verbose_name='Lunch')),
                ('tag_dinner', models.BooleanField(default=False, help_text='Select if this recipe is suitable for dinner', verbose_name='Dinner')),
