...
from apps.recipes.views import RecipeCreate, RecipeDetail, RecipeEdit, IndexPage, AuthorRecipes, FavoriteRecipes, RecipeDelete, Feed, ShopList, Cart
...
urlpatterns = [
    ...
    path('cart/list/', ShopList.as_view(), name='shop-list'),
